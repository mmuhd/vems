...
class CustomerController extends Controller
{
  public function create()
    ...
    public function store(Request $request)
    {
        ...
        $notification= array('title' => 'Data Update', 'body' => 'Tenant created Successfully');
        return redirect()->route('customer.create')->with('success',$notification);
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        if($customer->cellNo != $request->get('cellNo')){
            ...
            if(count($existsNumber)){
                ...
                $errors->add('cellNo', 'this mobile number belongs to another tenant!');
        ...
        $notification= array('title' => 'Data Update', 'body' => 'Tenant updated Successfully');
    ...
    public function destroy($id)
    {
        $customer = Customer::findOrFail($id);
        $customer->delete();
        $notification= array('title' => 'Data Remove', 'body' => 'Tenant deleted Successfully');
        return redirect()->route('customer.index')->with('success',$notification);
    }
