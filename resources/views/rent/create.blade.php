                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control datepicker" value="" name="deedStart" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <input type="number" id="rentAmount" class="form-control" min="0" value="0" name="rent" data-rule-number="true" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <input type="number" id="securityMoney" class="form-control" min="0.00" value="0" name="securityMoney" data-rule-number="true" required>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <input type="number" id="serviceCharge" class="form-control" min="0" value="0" name="serviceCharge" data-rule-number="true" required>
                                                ...
                                                <div class="card" id="flatInfo">
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="list-divided">
                                                            <ul class="list-divided">
                                                                <li><strong>size</strong>&nbsp;&nbsp;<span class="opacity-90" id="size"></span></li>
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="list-divided">
                                                            <ul class="list-divided">
                                                                ...
                                                                <li><strong>Referee</strong><br/><span class="opacity-90" id="contactPerson"></span></li>
                                                                <li><strong>Referee Mobile</strong><br/><span class="opacity-90" id="contactPersonCellNo"></span></li>
                                                            </ul>
                                                        </ul>
                                                    </div>
                                                </div>
