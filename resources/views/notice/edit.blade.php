          ...
          <div class="row">
            <div class="col-lg-12">
              <form class="form form-validate floating-label"
                    ...
                    action="{{URL::route('notice.update',$notice->id)}}"
                    method="POST"
                    ...
                    <div class="tab-pane active" id="first2">
                      ...
                      {{ method_field('PATCH') }}
                       ...
                       <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <select id="noticeType" class="form-control select2-list" value="{{$notice->noticeType}}" name="noticeType" required>
                          ...
                          <div class="form-group">
                            <div class="input-group date">
                              <div class="input-group-content">
                                <input type="text" name="entryDate" readonly value="{{$notice->entryDate->format('d/m/Y')}}" class="form-control  pick-date" >
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                        <div class="form-group">
                           <select id="format" class="form-control select2-list" value="{{$notice->format}}" name="format" required>
                      ...
                      <div class="col-lg-4">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$notice->name}}"  name="name" data-rule-minlength="4" maxlength="100" required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            <textarea class="form-control"  name="message" maxlength="5000">{{$notice->message}}</textarea>
