...
@section('content')
  <section>
    <div class="section-header">
      <ol class="breadcrumb">
        <li><a href="{{URL::Route('notice.index')}}">Notices</a></li>
               ...
               <div class="card card-underline">
                  ...
                  <div class="card-body tab-content">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                        <div class="form-group">
                          {!! Form::select('noticeType', ['' => '', 'landlord' => 'Landlord','tenant' =>'Tenant','all_landlords' => 'All Landlords','all_tenants' =>'All Tenants'], null, ['id' => 'noticeType' ,'class' => 'form-control select2-list', 'required' => 'required']) !!}
