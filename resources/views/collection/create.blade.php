                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <input type="text" id="collectionAmount" class="number form-control" name="amount"  required>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            {!! Form::select('collectionType', ['' => '', 'Cash' => 'Cash','Cheque' =>'Cheque', 'P.O' => 'Bank Deposit / Transfer'], null, ['id' => 'collectionType' ,'class' => 'form-control select2-list', 'required' => 'required']) !!}
                                                ...
                                                <div class="row" id="postOrderInfo">
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <label for="poNo">Teller/Transaction Reference No</label>
                                                            <p class="help-block">Max:255 letters</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <label for="poName">Depositor Name</label>
                                                            <p class="help-block">Max:255 letters</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <input type="date" id="poCode" class="form-control"  name="poCode" maxlength="255" required>
                                                            <label for="poCode">Date</label>
                                                            <p class="help-block">Transaction Date</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="form-group">
                                                            ...
                                                            <label for="note">Being Payment for</label>
                                                ...
                                                <div class="card" id="flatInfo">
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="list-divided">
                                                            ...
                                                            <li>Deduction Advance ₦: <strong><span class="opacity-90" id="monthlyDeduction"></span></strong></li>
                                                            <li>Deduction Tax ₦: <strong><span class="opacity-90" id="monthlyDeductionTax"></span></strong></li>
