                  ...
                  <div class="table-responsive no-margin">
                    <table class="table table-striped no-margin">
                      ...
                      <tr>
                        ...
                        <th width="20%" class="text-center">Tenant</th>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            @elseif($collection->collectionType == "P.O")
                              <span class="text-warning text-bold">Bank/Transfer, {{$collection->poNo}}, {{$collection->poName}}, {{$collection->poCode}}</span>
                            @else
                          ...
                          <td>
                            <div class="btn-group pull-right">
                              ...
                              <form class="myAction" method="POST" action="{{URL::route('collection.destroy',$collection->id)}}">
                                ...
                                @endcan
                                <a title="View" target="_blank" href="{{URL::route('collection.show',$collection->id)}}"  class="btn ink-reaction btn-floating-action btn-secondary btn-sm myAction"><i class="fa fa-print"></i>
                              </a>
                            </div>
                            <!--end .btn-group -->
                          </td>
