...
<html lang="en">
<head>
	<title>BASCO - @yield("title")</title>
	<!-- BEGIN META -->
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="keywords" content="vems,rent,estate,housing,manage,agency">
	<meta name="description" content="Dedicated Cloud Estate Management System">
	<!-- END META -->
				...
				<li class="header-nav-brand" >
					<div class="brand-holder">
						<a href="{{URL::Route('user.dashboard')}}">
							<span class="text-lg text-bold text-primary">BALA SABO & CO.</span>
						</a>
					</div>
				</li>
				<li>
			...
			<ul class="header-nav header-nav-options">
				...
				<li class="dropdown">
					<a href="javascript:void(0);" class="btn btn-icon-toggle btn-default" data-toggle="dropdown">
						<strong class="text-lg"> <i class="fa fa-folder"></i><sup class="badge style-danger" id="notiColBadge">0</sup></strong>
					</a>
...
<div id="base">
	...
	<div id="menubar" class="no-print">
		<div class="menubar-fixed-panel">
			...
			<div class="expanded">
				<a href="{{URL::Route('user.dashboard')}}">
					<span class="text-lg text-bold text-primary ">Vannia Estate Management System</span>
				</a>
			</div>
		</div>
		<div class="menubar-scroll-panel">
			...
			<!-- BEGIN LANDLORD -->
				<li class="gui-folder">
					...
					<!--start submenu -->
					<ul>
						<li><a href="{{URL::Route('landlord.create')}}" ><span class="title">New</span></a></li>
						<li><a href="{{URL::Route('landlord.index')}}" ><span class="title">All</span></a></li>
					</ul><!--end /submenu -->
				</li>
				<!-- END LANDLORD -->
				...
				<li class="gui-folder">
					<a>
						<div class="gui-icon"><i class="fa fa-2x fa-home"></i></div>
				...
				<li class="gui-folder">
					<a>
						<div class="gui-icon"><i class="fa fa- fa-users"></i></div>
				...
				<li class="gui-folder">
					<a href="{{URL::Route('renew.index')}}" >
						<div class="gui-icon"><i class="fa fa-plus-square"></i></div>
						<span class="title">Renew/Review</span>
					</a>
				...
				<li class="gui-folder">
					...
					<!--start submenu -->
					<ul>
						<li><a href="{{URL::Route('remittance.create')}}" ><span class="title">New</span></a></li>
						<li><a href="{{URL::Route('remittance.index')}}" ><span class="title">All</span></a></li>
					</ul><!--end /submenu -->
				</li>
				<!-- END Remittance -->
				<!-- BEGIN Notices -->
				<li class="gui-folder">
					...
					<!--start submenu -->
					<ul>
						<li><a href="{{URL::Route('notice.create')}}" ><span class="title">Create</span></a></li>
						<li><a href="{{URL::Route('notice.index')}}" ><span class="title">View/Send</span></a></li>
						<li><a href="{{URL::Route('notice.logindex')}}" ><span class="title">Log</span></a></li>
					</ul><!--end /submenu -->
				</li><!--end /menu-li -->
				<li class="gui-folder">
					<a>
					...
					<!--start submenu -->
					<ul>
						<li><a href="{{URL::Route('repairs.create')}}" ><span class="title">Create</span></a></li>
						<li><a href="{{URL::Route('repairs.index')}}" ><span class="title">All</span></a></li>
					</ul><!--end /submenu -->
				</li><!--end /menu-li -->
				<!-- END Repairs -->
			@if(Gate::check('report.projects') || Gate::check('report.rentalStatus') || Gate::check('report.dues') || Gate::check('report.flats') || Gate::check('report.customers') || Gate::check('report.landlords') || Gate::check('report.rents') || Gate::check('report.collections') || Gate::check('report.expenses') || Gate::check('report.remittances') || Gate::check('report.balance') || Gate::check('report.landlord_properties'))
				<!-- BEGIN REPORT -->
					<li class="gui-folder">
						<a>
						...
						<ul>
							@if(Gate::check('report.projects'))
								<li><a href="{{URL::Route('report.projects')}}" ><span class="title">Properties</span></a></li>
							@endif
							@if(Gate::check('report.landlord_properties'))
								<li><a href="{{URL::Route('report.landlord_properties')}}" ><span class="title">Landlord Properties</span></a></li>
							@endif
							...
							@if(Gate::check('report.customers'))
								<li><a href="{{URL::Route('report.customers')}}" ><span class="title">Tenants</span></a></li>
							@endif
							@if(Gate::check('report.landlords'))
								<li><a href="{{URL::Route('report.landlords')}}" ><span class="title">Landlords</span></a></li>
							@endif
		...
		<!-- 			@if(Gate::check('report.collectionSummary'))
							...
							@endif
							@if(Gate::check('report.remittances'))
								<li><a href="{{URL::Route('report.remittances')}}" ><span class="title">Remittances</span></a></li>
							@endif
			...
			@if(Gate::check('mail.compose'))
				...
				<!-- BEGIN user -->
					<li class="gui-folder">
						<a>
							<div class="gui-icon"><i class="fa fa- fa-user"></i></div>
			...
			<div class="menubar-foot-panel">
				<small class="no-linebreak hidden-folded">
					<span class="opacity-75">Copyright &copy; {{date('Y')}}</span> <a href="#" target="_blank"><strong>VEMS</a></strong>
				</small>
			</div>
...
<script type="text/javascript">
	var makeNotificationItem = function(notification,typeClass){
        ...
        if(typeClass != "notiToItem") {
            notiItem += '<small>&#0012₦; ' + parseFloat(notification.value).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') + '</small>';
        }
        else{
