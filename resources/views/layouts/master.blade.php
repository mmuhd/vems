	...
	<div id="menubar" class="no-print">
		...
		<div class="menubar-scroll-panel">
			...
			<!-- BEGIN LANDLORD -->
				...
				<li class="gui-folder">
					<a>
						<div class="gui-icon"><strong class="text-bold"><i class="fa fa-ngn">&#0012₦</i></div></strong>
				...
				<!-- END Notices -->
			@if(Gate::check('report.projects') || Gate::check('report.rentalStatus') || Gate::check('report.dues') || Gate::check('report.flats') || Gate::check('report.customers') || Gate::check('report.landlords') || Gate::check('report.rents') || Gate::check('report.collections') || Gate::check('report.expenses') || Gate::check('report.remittances') || Gate::check('report.balance'))
				<!-- BEGIN REPORT -->
					<li class="gui-folder">
						<a>
