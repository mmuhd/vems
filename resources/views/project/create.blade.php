                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control"  name="projectId" value="BS/" data-rule-minlength="2" maxlength="255" >
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <select id="projectType" class="form-control select2-list" name="projectType" >
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control"  name="name" data-rule-minlength="2" maxlength="255" >
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control datepicker" value="{{$today->format('d/m/Y')}}" name="entryDate" >
                    ...
                    <div class="row">
                       <div class="col-lg-6">
                        <div class="form-group">
                           <select id="storied" class="form-control select2-list" name="storied" >
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control"  name="noOfFloor" value="1" data-rule-number="true" >
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control"  name="noOfUnits" value="1" data-rule-number="true" >
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control"  name="noOfCarParking" value="1" data-rule-number="true" >
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                         {!! Form::select('landlords_id', $landlords, null, ['class' => 'form-control select2-list', '' => '']) !!}   
                          <label for="landlords">Property Landlord</label>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control"  name="agencyFee" >
