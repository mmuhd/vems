                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="number" class="form-control" value="{{$project->lat}}" name="lat" data-rule-minlength="4" maxlength="20" required>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="number" class="form-control" value="{{$project->lang}}" name="lang" data-rule-minlength="4" maxlength="20" required>
                    ...
                    <div class="row">
                       <div class="col-lg-6">
                        <div class="form-group">
                           <select id="storied" class="form-control select2-list" value="{{$project->storied}}" name="storied" required>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" class="form-control" value="{{$project->agencyFee}}" name="agencyFee" required>
