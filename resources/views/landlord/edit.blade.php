                  ...
                  <div class="card-body tab-content">
                    <div class="tab-pane active" id="first2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            <div class="input-group date">
                              <div class="input-group-content">
                                <input type="text" readonly value="{{$landlord->entryDate->format('d/m/Y')}}" class="form-control  pick-date" required>
                       ...
                       <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$landlord->fatherName}}" name="fatherName" maxlength="100" required>
                         ...
                         <div class="col-lg-6">
                          <div class="form-group">
                             <textarea class="form-control"  name="mailingAddress" maxlength="500" required>{{$landlord->mailingAddress}}</textarea>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                           <input type="text" class="form-control" value="{{$landlord->motherName}}" name="motherName" maxlength="100" required>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                             <select id="passportNo" class="form-control select2-list"  value="{{$landlord->passportNo}}" name="passportNo" required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            <textarea class="form-control"  name="permanentAddress"  maxlength="500" required>{{$landlord->permanentAddress}}</textarea>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$landlord->spouseName}}" name="spouseName" maxlength="100" required>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$landlord->contactPerson}}" name="contactPerson" maxlength="100" required>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$landlord->contactPersonCellNo}}"  name="contactPersonCellNo" data-rule-minlength="11" maxlength="11" required>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <select id="landlordType" class="form-control select2-list" value="{{$landlord->landlordType}}" name="landlordType" required>
