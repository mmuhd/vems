...
@section('content')
  <section>
    <div class="section-header">
      <ol class="breadcrumb">
        <li><a href="{{URL::Route('landlord.index')}}">Landlords</a></li>
          ...
          <div class="row">
            <div class="col-lg-12">
              <form class="form form-validate floating-label"
                    ...
                    action="{{URL::route('landlord.store')}}"
                    method="POST"
                  ...
                  <div class="card-body tab-content">
                    <div class="tab-pane active" id="first2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('cellNo')}}" name="cellNo" data-rule-minlength="11" maxlength="11">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            <div class="input-group date">
                              <div class="input-group-content">
                                <input type="text" name="entryDate" value="@if(old('entryDate')) {{old('entryDate')}} @else {{$today->format('d/m/Y')}} @endif" class="form-control  pick-date">
                       ...
                       <div class="row">
                        <div class="col-lg-6">
                         ...
                         <div class="col-lg-6">
                          <div class="form-group">
                            <textarea class="form-control"  name="mailingAddress" maxlength="500" value="Kano">{{old('mailingAddress')}}</textarea>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('motherName')}}" name="motherName" maxlength="100" value="Nigerian">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                             <select id="passportNo" class="form-control select2-list" name="passportNo">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            <input type="text" id="nidNo" class="form-control" value="{{old('nidNo')}}"  name="nidNo" maxlength="50">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            <textarea class="form-control"  name="permanentAddress"  maxlength="500" value="Kano">{{old('permanentAddress')}}</textarea>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('NUBAN')}}"  name="NUBAN" data-rule-minlength="10" maxlength="10">
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <select id="landlordType" class="form-control select2-list" name="landlordType" required>
