                    ...
                    <div class="tab-pane active" id="first2">
                      ...
                      <div class="row">
                       ...
                       <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('fatherName')}}" name="fatherName" maxlength="100" required>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('motherName')}}" name="motherName" maxlength="100" required>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                             <select id="passportNo" class="form-control select2-list" name="passportNo" required>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('spouseName')}}" name="spouseName" maxlength="100" required>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('contactPerson')}}" name="contactPerson" maxlength="100" required>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('contactPersonCellNo')}}"  name="contactPersonCellNo" data-rule-minlength="11" maxlength="11" required>
