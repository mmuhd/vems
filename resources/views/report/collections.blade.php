                    ...
                    <div class="col-md-12">
                      <table class="table table-striped">
                        ...
                        <tr>
                          ...
                          <th width="25%" class="text-center">Tenant</th>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              @elseif($collection->collectionType == "P.O")
                                <span class="text-warning text-bold">Bank Deposit/Transfer, {{$collection->poNo}}, {{$collection->poName}}, {{$collection->poCode}}</span>
                              @else
