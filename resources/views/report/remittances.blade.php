...
@section('title', 'Report-remittance')
@section('extraStyle')
          ...
          <div class="row no-print">
            <div class="col-lg-12">
              <form class="form form-validate floating-label"
                    ...
                    action="{{URL::route('report.remittances')}}"
                    method="GET"
                ...
                <div class="card-body style-default-bright top-zero">
                  <div class="row">
                    ...
                    <div class="col-xs-5 text-left">
                      <h3 class="text-light text-default-light"><strong>Remittances @if($project !="All" and count($remittances)) [{{ $remittances[0]->project->name }}] @endif </strong></h3>
                    </div>
                      ...
                      <table class="table table-striped">
                        ...
                        @foreach($remittances as $remittance)
                          <tr>
                            ...
                            @endif
                            <td colspan="@if($project !="All")2 @endif" class="text-center">{{$remittance->amount}}
                              @php ($grandTotal += $remittance->amount)
                            </td>
                            <td class="text-center">{{$remittance->note}}</td>
