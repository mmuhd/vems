...
@section('content')
  <section>
    <div class="section-header no-print">
      <ol class="breadcrumb">
        <li class="active">Tenants Report</li>
      </ol>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="tenant name" name="name" value="{{$name}}">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="tenant mobile no" name="mobileNo" value="{{$mobileNo}}">
                        </div>
                      </div>
                      <div class="col-lg-2">
                        <div class="form-group">
                ...
                <div class="card-body style-default-bright top-zero">
                  <div class="row">
                    ...
                    <div class="col-xs-5 text-left">
                      <h3 class="text-light text-default-light"><strong>Tenants @if($status != "All")[ @if($status == "No") Inactive @else Active @endif] @endif</strong></h3>
                    </div>
                    ...
                    <div class="col-md-12">
                      <table class="table table-striped">
                        ...
                        <tr>
                          ...
                          <th style="width:10%" class="text-center">Refree</th>
                          <th style="width:10%" class="text-center">Refree Mobile No</th>
                          @if($status == "All")
