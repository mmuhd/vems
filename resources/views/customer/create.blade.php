...
@section('content')
  <section>
    <div class="section-header">
      <ol class="breadcrumb">
        <li><a href="{{URL::Route('customer.index')}}">Tenants</a></li>
                  ...
                  <div class="card-body tab-content">
                    <div class="tab-pane active" id="first2">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{old('name')}}"  name="name" data-rule-minlength="4" maxlength="100" >
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            <textarea class="form-control"  name="permanentAddress"  maxlength="500" >{{old('permanentAddress')}}</textarea>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <select id="customerType" class="form-control select2-list" name="customerType" >
