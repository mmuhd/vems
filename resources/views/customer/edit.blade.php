                  ...
                  <div class="card-body tab-content">
                    <div class="tab-pane active" id="first2">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$customer->fatherName}}" name="fatherName" maxlength="100" required>
                         ...
                         <div class="col-lg-6">
                          <div class="form-group">
                             <textarea class="form-control"  name="mailingAddress" maxlength="500" required>{{$customer->mailingAddress}}</textarea>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$customer->motherName}}" name="motherName" maxlength="100" required>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                             <select id="passportNo" class="form-control select2-list" value="{{$customer->passportNo}}" name="passportNo" required>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                             <input type="text" class="form-control" value="{{$customer->contactPerson}}" name="contactPerson" maxlength="100" required>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                           <input type="text" class="form-control" value="{{$customer->contactPersonCellNo}}"  name="contactPersonCellNo" data-rule-minlength="11" maxlength="11" required>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <select id="customerType" class="form-control select2-list" value="{{$customer->customerType}}" name="customerType" required>
