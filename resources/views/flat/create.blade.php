                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <label for="projectType">Property</label>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <input type="text" id="flatSize" class="form-control"  name="size" data-rule-minlength="2" maxlength="255" required>
...
@section('extraScript')
  ...
  <script type="text/javascript">
      ...
      $( document ).ready(function() {
          ...
          $('#flatSize').on('input projectchange paste',function () {
              generateDescription();
          });
